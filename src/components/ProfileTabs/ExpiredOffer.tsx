              ...
              <div key={i} className="py-0.5 grid grid-cols-4 pt-2">
                ...
                <div className="flex items-center">
                  {item.offer === account?.address?.toString() && (
                    <button
                      className="px-4 py-1  bg-[#63C3A7] text-gray-200 text-base font-semibold hover:bg-[#40a789] rounded-full flex items-center justify-center"
                      // onClick={() =>
                      //   item.isforitem
                      //     ? cancelOffer(item)
